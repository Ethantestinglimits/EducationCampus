	...
	var yWidget = {
		...
		id: '420552',
		href: 'https://n420552.yclients.com/',
        script_href: 'https://w420552.yclients.com/',
		lang: 'rus',
		isNew: '1',
	...
	initYandexMetrika: function () {
      ...
      loadSuperButton: function() {
        ...
        window.yClientsWidgetOptions = {
            target: outlet,
            widgetBaseUrl: 'https://n420552.yclients.com',
            companyId: '398283',
            widgetId: '420552',
        ...
        link.setAttribute('href', 'superbutton/superbutton.css');
		document.head.appendChild(link);

        var script = document.createElement('script');
        script.setAttribute('src', 'https://n420552.yclients.com/superbutton/superbutton.umd.min.js');
